"""Smoke test for one-hot theta-flow mode in ``bin/study_h_decoding_convergence.py``."""
...
class TestStudyHDecodingConvergenceOneHotThetaFlowSmoke(unittest.TestCase):
    def test_theta_flow_onehot_state_smoke(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn("theta_flow one-hot state enabled", r.stdout)
