...
description: >-
  ...
  and lxfs budget as benchmark-1D; optional --lxf-low-rank-dim (default 3) for the low-rank row. Use when the user
...
| **Low-rank** | `--lxf-low-rank-dim` defaults to **3** (override if you want another rank for `linear_x_flow_low_rank_t`) |
